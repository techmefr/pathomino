...
window.PM = {
  ...
  SVG: {
    ...
    tetro:'<svg viewBox="0 0 24 24" fill="currentColor"><rect x="4" y="1" width="7" height="7" rx="1.5"/><rect x="4" y="9" width="7" height="7" rx="1.5"/><rect x="4" y="17" width="7" height="7" rx="1.5"/><rect x="12" y="17" width="7" height="7" rx="1.5"/></svg>',
    draw:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="5" y="3" width="14" height="18" rx="2"/><path d="M14 12H9"/><path d="M12 9l-3 3 3 3"/></svg>',
    trash:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M8 6V4h8v2"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v5M14 11v5"/></svg>'
  },
};
